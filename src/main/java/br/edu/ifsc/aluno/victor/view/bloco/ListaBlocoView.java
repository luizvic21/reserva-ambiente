 ...
 * @author unknown
 */
public class ListaBlocoView extends JFrame {

    public ListaBlocoView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                //======== panel2 ========
                {
                    ...
                    //======== scrollPane1 ========
                    {
                        ...
                        //---- listagemTbt ----
                        listagemTbt.setBorder(new BevelBorder(BevelBorder.RAISED));
                        listagemTbt.setModel(new DefaultTableModel(
                            new Object[][] {
                            },
                            new String[] {
                                "id", null
            ...
            //======== panel1 ========
            {
                ...
                //---- tituloLbl ----
                tituloLbl.setText("Listagem de blocos");
