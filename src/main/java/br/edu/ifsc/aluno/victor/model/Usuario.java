...
public class Usuario extends Pessoa {
    ...
    public Usuario(int id, String nome, LocalDate dataNascimento, String fone, String fone2, String email, String cpf, String rg, Endereco endereco, String username, String senha) {
